...
Next HiCar支持无线连接，并强烈建议所有接入Next HiCar的设备都能够支持无线连接的方式使用Next HiCar，但由于部分硬件上的原因，部分手机和车型存在无法无线连接Next HiCar的情况。

## 前提条件

1. 您的手机支持Next HiCar，并且支持无线连接。仅有少数的手机不支持Next HiCar无线连接，仅支持有线连接。手机相关的支持情况，您可以在这里查询[HiCar支持的手机](https://developer.huawei.com/consumer/cn/doc/development/HiCar-Guides/available-phones-0000001227954439)。
...
5. 在弹出的“允许自动连接 HiCar”，建议选择“允许”。


## 扫码连接操作步骤

此步骤适用于绝大多数盒子方案使用Next HiCar的场景。
